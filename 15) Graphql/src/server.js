...
const {
  ...
  save,
  messageNormalize,
} = require("../controller/socketController.js");
const { HomeServices } = require("../services/homeServices.js");

// Graphql
const graphqlFunction = require("../graphql/index.js");
...
const logger = new HomeServices().logger;
